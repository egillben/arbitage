 ...
 * @notice Solidity 0.8.x includes built-in overflow checking, but we include this for
 * compatibility with contracts that might still rely on it and for explicit clarity
 */
library SafeMath {
    /**
